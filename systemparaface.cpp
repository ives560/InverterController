...
{
    setTitle("系统参数",":/images/kaiguanji.png");
    /*------------------*/
    ...
    setupMenuButton(tbtn_language,"语言",QPoint(300,100),":/images/run.png");
    ...
    setupMenuButton(tbtn_clock,"时钟",QPoint(400,100),":/images/run.png");
    /*------------------*/
    ...
    setupMenuButton(tbtn_protect,"发电总量校正",QPoint(300,200),":/images/private.png");
    /*------------------*/
    ...
    setupMenuButton(tbtn_comm,"恢复出厂值",QPoint(400,200),":/images/comm.png");
}
//语言设置
